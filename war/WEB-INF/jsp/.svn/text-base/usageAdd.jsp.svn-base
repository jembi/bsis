    ...
    <div class="mainContent">
        ...
        <div class="leftPanel">
            <ul id="usageTabs" class="leftPanelTabs">
                <li id="addUsageTab" class="selectedTab"><a href="usageAdd.html">Add</a></li>
                <li id="updateUsageTab"><a href="updateUsage.html">Update</a></li>
            </ul>
        </div>
        <div class="centerPanel">
            <div class="centralContent">
                <form:form action="addNewUsage.html" id="addUsageForm">
                    <div class="message" id="usageErrorMessagePanel">
                    </div>
                    <c:if test="${model.usageDeleted==true}">
                        <div class="infoMessage">
                            Usage of Product Number ${model.deletedUsageProductNumber} deleted
                        </div>
                    </c:if>
                    ...
                    <div id="actionButtons" class="actionButtonsPanel">
                        <input id="addUsageButton" type="button" value="Add"/>
                    </div>
                </form:form>
            </div>
        </div>
