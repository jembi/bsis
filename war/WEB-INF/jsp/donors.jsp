...
<div id="donorsTab" class="leftPanel">
	<ul>
		<li id="findOrAddDonorsContent"><a href="#findOrAddDonors">Find/Add
				Donor</a></li>
		<li id="viewDonorsContent"><a href="viewDonors.html">View Donors</a></li>
	</ul>
	<div id="findOrAddDonors" class="centerPanel">Find/Add Donors</div>
</div>

<div class="centerPanel" style="display: none;">
	<div class="centralContent">
		<div id="donor">
            ...
            <c:otherwise>
				...
				<c:if test="${model.donorNotFound==true}">
					<div id="donorErrorMessagePanel" class="message">This donor
						is not present in records. Please create a new entry.</div>
				</c:if>
				<div id="donorValidationErrorMessagePanel" class="message"></div>
        ...
        Donor No. ${model.donorNumberDeleted} deleted
				...
				<form:form action="findDonor.html" id="donorAction">
					<div id="donorDetails">
						...
						<div class="inputFieldRow">
							<label for="donorNumber">${model.donorIDDisplayName}: </label><input
								req="true" type="text" maxlength="32" id="donorNumber"
								name="donorNumber"
                    ...
                    value="${model.displayDonorNumber}"
						...
						<c:if test="${model.showfirstName==true}">
							...
							<div class="inputFieldRow">
								<label for="firstName">${model.firstNameDisplayName}: </label><input
									req="true" type="text" maxlength="32" id="firstName"
									name="firstName"
						...
						<c:if test="${model.showbloodType==true}">
							...
							<div class="createDonorField inputFieldRow">
								<label for="bloodType">${model.bloodTypeDisplayName}: </label> <select
						...
						<c:if test="${model.showdateOfBirth==true}">
							...
							<div class="createDonorField inputFieldRow">
								...
								<div class="infoMessage" style="margin: 0px; padding: 0px;">
									...
									</label> <label style="width: 30px; margin: 2px 0 0 17px;"> dd
										/ </label> <label style="width: 50px; margin: 2px 0 0 25px;">
										yyyy </label>
								</div>
							</div>
							<div class="createDonorField inputFieldRow"
					...
					<div class="actionButtonsPanel" id="createDonorButtonPanel">
						<input id="createDonorButton" type="button" value="Create Donor" />
						<a class="link backToFindDonor">Back</a>
					</div>


					<div class="actionButtonsPanel" id="updateDonorButtonPanel">
						<input id="updateDonorButton" type="button" value="Update Donor" />
						<input id="deleteDonorButton" type="button" value="Delete Donor" />
						<a class="link backToFindDonor">Back</a>
					</div>
				...
				<c:if test="${model.donorHistory!=null}">
					<div id="donorHistory">
						<div id="donorHistoryHeadingPanel" class="collapsibleHeadingPanel"
