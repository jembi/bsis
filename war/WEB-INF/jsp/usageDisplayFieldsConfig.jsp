    ...
    <div class="mainContent">
        ...
        <div class="leftPanel">
            <ul id="displayFieldsTabs" class="leftPanelTabs">
                ...
                <li id="usageTab" class="selectedTab"><a href="admin-usageDisplayFieldsConfig.html">Usage</a>
                </li>
        ...
        <div class="centerPanel">
            <div class="centralContent">
                ...
                <div id="displayFieldsConfigPanel" class="tabbedPanel">
                    ...
                    <form:form action="admin-saveUsageDisplayFieldsConfig.html">


                    <div id="usageConfigOptions" style="clear:both;margin-top: 10px;">

                        <div class="inputFieldRow">
                            <input type="checkbox" id="usageDate" name="usageDate" value="true"
                                   <c:if test="${model.showusageDate=='true'}">checked="checked"</c:if>
                                    />
                            <label for="usageDate" class="checkboxLabel">Usage Date</label>
                        </div>

                        <div class="inputFieldRow">
                            <input type="checkbox" id="hospital" name="hospital" value="true"
                                   <c:if test="${model.showhospital=='true'}">checked="checked"</c:if>
                                    />
                            <label for="hospital" class="checkboxLabel">Hospital</label>
                        </div>
                        <div class="inputFieldRow">
                            <input type="checkbox" id="ward" name="ward" value="true"
                                   <c:if test="${model.showward=='true'}">checked="checked"</c:if>
                                    />
                            <label for="ward" class="checkboxLabel">Ward</label>
                        </div>
                        <div class="inputFieldRow">
