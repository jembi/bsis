    ...
    <div class="mainContent">
        ...
        <div class="leftPanel">
            <ul id="testResultsTabs" class="leftPanelTabs">
                <li id="addTestResultsTab" class="selectedTab"><a href="testResultsAdd.html">Add</a></li>
                <li id="updateTestResultsTab"><a href="testResultsView.html">View</a></li>
            </ul>
        </div>
            ...
            <div class="centralContent">
                <div id="testResults">
                    <div id="testResultsMessagePanel" class="infoMessage">
                        ...
                        <c:if test="${model.testResultDeleted==true}">
                            Test Result Deleted Successfully
                        </c:if>
                    </div>
                    <div id="testResultsErrorMessagePanel" class="message"></div>
                    <form:form action="addNewTestResults.html" id="addTestResultsForm">
                        ...
                        <div id="actionButtons" class="actionButtonsPanel">
                            <input id="addTestResultButton" type="button" value="Add"/>
                        </div>
                    </form:form>
                </div>
