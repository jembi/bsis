    ...
    <div class="mainContent">
        ...
        <div class="leftPanel">
            <ul id="requestsTabs" class="leftPanelTabs">
                <li id="addRequestsTab" class="selectedTab"><a href="requestsAdd.html">Add</a></li>
                <li id="updateRequestsTab"><a href="viewAllRequests.html">View</a></li>
            </ul>
        </div>
        <div class="centerPanel">
            <div class="centralContent">
                <form:form action="addNewRequest.html" id="addRequestsForm">
                    <div class="message" id="requestsErrorMessagePanel">
                    </div>
                    <c:if test="${model.requestDeleted==true}">
                        <div class="infoMessage">
                            Request ${model.deletedRequestNumber} deleted
                        </div>
                    </c:if>
                    ...
                    <div id="actionButtons" class="actionButtonsPanel">
                        <input id="addRequestButton" type="button" value="Add"/>
                    </div>
                </form:form>
            </div>
        </div>
