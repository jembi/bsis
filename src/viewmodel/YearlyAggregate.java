...
public class YearlyAggregate {
	...
	public static YearlyAggregate createWithCollections(
			List<Collection> collections) {
		YearlyAggregate yearlyAggregate = new YearlyAggregate();
		yearlyAggregate.aggregates = new TreeMap<Date, Integer>(
				new Comparator<Date>() {
				...
				new Transformer() {
					public Object transform(Object o) {
						...
						DateTime dateTime = new DateTime(collection
								.getDateCollected());
						DateTime firstDayOfYear = dateTime.minusDays(
								dateTime.getDayOfMonth() - 1).minusMonths(
	...
	public static YearlyAggregate createWithProducts(
	...
	public static YearlyAggregate createWithTestResults(
	...
	public LinkedHashMap<Date, Integer> getFilledYearlyAggregate(
