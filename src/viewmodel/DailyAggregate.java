...
public class DailyAggregate {
    ...
    public static DailyAggregate createWithCollections(ArrayList<Collection> collections) {
        ...
        for (Date uniqueDate : uniqueDates) {
            ...
            List<Collection> dailyCollections = (List<Collection>) CollectionUtils.select(collections, new Predicate() {
                public boolean evaluate(Object o) {
                    Collection collection = (Collection) o;
                    if (collection.getDateCollected().equals(collectionDate)) {
                        return true;
                    }
                    return false;
                }
    ...
    public static DailyAggregate createWithProducts(ArrayList<Product> filteredProducts) {
        DailyAggregate dailyAggregate = new DailyAggregate();
        dailyAggregate.aggregates = new HashMap<Date, Integer>();
        ...
        for (Date uniqueDate : uniqueDates) {
            ...
            List<Product> dailyProducts = (List<Product>) CollectionUtils.select(filteredProducts, new Predicate() {
                public boolean evaluate(Object o) {
                    Product product = (Product) o;
                    if (product.getDateCollected().equals(collectionDate)) {
                        return true;
                    }
                    return false;
                }
    ...
    public static DailyAggregate createWithTestResults(ArrayList<TestResult> filteredTestResults) {
        DailyAggregate dailyAggregate = new DailyAggregate();
        dailyAggregate.aggregates = new HashMap<Date, Integer>();
        ...
        for (Date uniqueDate : uniqueDates) {
            ...
            List<TestResult> dailyTestResults = (List<TestResult>) CollectionUtils.select(filteredTestResults, new Predicate() {
                public boolean evaluate(Object o) {
                    TestResult testResult = (TestResult) o;
                    if (testResult.getDateCollected().equals(collectionDate)) {
                        return true;
                    }
                    return false;
                }
    ...
    public LinkedHashMap<Date, Integer> getFilledDailyAggregate(LinkedHashMap<Date, Integer> orderedAggregates) {
