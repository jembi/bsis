...
import org.jembi.bsis.repository.UsageRepository;
...
public class UsageRepositoryTest extends DBUnitContextDependentTestSuite {
  ...
  protected IDataSet getDataSet() throws Exception {
    File file = new File("src/test/resources/dataset/UsageRepositoryDataset.xml");
  ...
  @Test
  @Ignore("Bug - error in HSQL: dateUsed of: org.jembi.bsis.model.usage.ComponentUsage [SELECT u FROM org.jembi.bsis.model.usage.ComponentUsage u WHERE (u.component.componentCode = :componentCode OR u.useIndication IN (:useIndications)) AND (u.dateUsed BETWEEN :dateUsedFrom AND :dateUsedTo) AND (u.isDeleted= :isDeleted)]")
