...
public class ComponentCRUDServiceTests extends UnitTestSuite {
  ...
  @Test
  public void testPreProcessComponentInvalidWeightUpdatedToInvalidWeight_shouldDiscardComponent() throws Exception {
    // set up data
    long componentId = 1L;
    Donation donation = aDonation().withPackType(aPackType().withLowVolumeWeight(316).withMinWeight(400).withMaxWeight(500).build()).build();
    Component oldComponent = aComponent()
    ...
    // SUT
    Component updatedComponent = componentCRUDService.preProcessComponent(componentId, 200, null, null);

    // check
    verify(componentCRUDService, times(0)).markComponentAsUnsafe(oldComponent, ComponentStatusChangeReasonType.INVALID_WEIGHT);
    assertThat("Component is still unsafe", updatedComponent.getStatus(), is(ComponentStatus.UNSAFE));
  }

  @Test
  public void testPreProcessComponentLowWeightUpdatedToLowWeight_shouldDiscardComponent() throws Exception {
    // set up data
    long componentId = 1L;
    Donation donation = aDonation().withPackType(aPackType().withLowVolumeWeight(316).withMinWeight(400).withMaxWeight(500).build()).build();
    Component oldComponent = aComponent()
        ...
        .withComponentStatusChange(aComponentStatusChange()
            ...
            .withStatusChangeReason(aComponentStatusChangeReason()
                .withId(27L)
                .withComponentStatusChangeReasonCategory(ComponentStatusChangeReasonCategory.UNSAFE)
                .withComponentStatusChangeReasonType(ComponentStatusChangeReasonType.LOW_WEIGHT)
                .build())
            .build())
        .withDonation(donation)
        .build();
    ...
    // check
    verify(componentCRUDService, times(0)).markComponentAsUnsafe(oldComponent, ComponentStatusChangeReasonType.LOW_WEIGHT);
    assertThat("Component is still unsafe", updatedComponent.getStatus(), is(ComponentStatus.UNSAFE));
  }

  @Test
  public void testPreProcessComponentInvalidUpdatedToLowWeight_shouldDiscardComponent() throws Exception {
    // set up data
    long componentId = 1L;
    Donation donation = aDonation().withPackType(aPackType().withLowVolumeWeight(316).withMinWeight(400).withMaxWeight(500).build()).build();
    Component oldComponent = aComponent()
  ...
  @Test
  public void testPreProcessComponentLowWeightUpdatedToInvalidWeight_shouldDiscardComponent() throws Exception {
    // set up data
    long componentId = 1L;
    Donation donation = aDonation().withPackType(aPackType().withLowVolumeWeight(316).withMinWeight(400).withMaxWeight(500).build()).build();
    Component oldComponent = aComponent()
