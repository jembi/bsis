...
public class BloodTestingRuleEngineTests extends UnitTestSuite {
  ...
  public void testApplyBloodTestsWithNTAndNegTests_ttiStatusShouldBeIndeterminate() throws Exception {
    ...
    // Setup mocks
    when(bloodTestRepository.getActiveBloodTestingRules()).thenReturn(rules);
    when(bloodTestRepository.getRecentTestResultsForDonation(donation.getId())).thenReturn(resultsMap);
