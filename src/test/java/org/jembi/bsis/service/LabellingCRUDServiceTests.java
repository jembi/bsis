...
public class LabellingCRUDServiceTests extends UnitTestSuite {

  @InjectMocks
  LabellingCRUDService labellingCRUDService;
  ...
  public void testPrintDiscardLabel_shouldReturnZPLContainingText() throws Exception {
    ...
    // run test
    String label = labellingCRUDService.printDiscardLabel(componentId);
  ...
  public void testPrintDiscardLabel_throwsException() throws Exception {
    ...
    // run test
    labellingCRUDService.printDiscardLabel(componentId);
  }
  ...
  public void testPrintPackLabelWithPositiveRhBlood_shouldReturnZPLContainingText() throws Exception {
    ...
    // run test
    String label = labellingCRUDService.printPackLabel(componentId);
  ...
  public void testPrintPackLabelWithNotInStockComponent_shouldMarkAsInStock() throws Exception {
    ...
    // run test
    labellingCRUDService.printPackLabel(componentId);
