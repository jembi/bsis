...
public class ComponentTypeMatcher extends TypeSafeMatcher<ComponentType> {
  
  private ComponentType expected;
  
  public ComponentTypeMatcher(ComponentType expected) {
  ...
  @Override
  public boolean matchesSafely(ComponentType actual) {
  ...
  public static ComponentTypeMatcher hasSameStateAsComponentType(ComponentType expected) {
    return new ComponentTypeMatcher(expected);
  }
}
