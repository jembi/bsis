...
public class DiscardedComponentDTOMatcher extends TypeSafeMatcher<DonorExportDTO> {

  private DonorExportDTO expected;

  public DiscardedComponentDTOMatcher(DonorExportDTO expected) {
  ...
  public static DiscardedComponentDTOMatcher hasSameStateAsDonorExport(DonorExportDTO expected) {
