...
public class BloodTestingRuleBackingFormValidator extends BaseValidator<BloodTestingRuleBackingForm> {
  ...
  public void validateForm(BloodTestingRuleBackingForm form, Errors errors) {
    ...
    Set<String> pendingTestsIds = form.getPendingTestsIds();
  ...
  private String validatePendingTest(String idStr, BloodTest bloodTest, String pendingTestsError) {
    Long id = null;
    try {
      id = Long.valueOf(idStr);
    } catch (Exception e) {
      pendingTestsError += ", " + idStr;
    }
    if (id != null) {
