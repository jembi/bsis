...
public class ControllerUtil {
    ...
    public static void addFieldsToDisplay(String recordType, Map<String, Object> model, RecordFieldsConfigRepository recordFieldsConfigRepository) {
        String fieldNames = recordFieldsConfigRepository.getRecordFieldsConfig(recordType).getFieldNames();
    ...
    public static void addDonorDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "donor", DONOR_DEFAULT_NAMES);
    }

    public static void addCollectionDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "collection", COLLECTION_DEFAULT_NAMES);
    }

    public static void addTestResultDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "testResults", TEST_RESULT_DEFAULT_NAMES);
    }

    public static void addProductDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "product", PRODUCT_DEFAULT_NAMES);
    }

    public static void addRequestDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "request", REQUEST_DEFAULT_NAMES);
    }

    public static void addIssueDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "issue", ISSUE_DEFAULT_NAMES);
    }

    public static void addUsageDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "usage", USAGE_DEFAULT_NAMES);
    }

    public static void addReportsDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository) {
        addDisplayNamesToModel(model, displayNamesRepository, "reports", REPORTS_DEFAULT_NAMES);

    }

    public static void addCollectionReportConfigFieldsToModel(Map<String, Object> model, ReportConfigRepository reportConfigRepository) {
        addReportConfigToModel(model, reportConfigRepository, "collection");
    }

    public static void addProductReportConfigFieldsToModel(Map<String, Object> model, ReportConfigRepository reportConfigRepository) {
        addReportConfigToModel(model, reportConfigRepository, "product");
    }

    public static void addTestResultsReportConfigFieldsToModel(Map<String, Object> model, ReportConfigRepository reportConfigRepository) {
        addReportConfigToModel(model, reportConfigRepository, "testResults");
    }

    private static void addReportConfigToModel(Map<String, Object> model, ReportConfigRepository reportConfigRepository, String reportType) {
        String fieldNames = reportConfigRepository.getReportConfig(reportType).getFieldNames();
        String[] fields = fieldNames.split(",");
        for (String field : fields) {
    ...
    private static void addDisplayNamesToModel(Map<String, Object> model, DisplayNamesRepository displayNamesRepository, String recordType, Map<String, String> default_names) {
        String[] fields = displayNamesRepository.getDisplayName(recordType).getFieldNames().split(",");
        for (String field : fields) {
    ...
    public static Long getOptionalParamValue(Long param, RecordFieldsConfig recordFields, String fieldName) {
    ...
    public static String getOptionalParamValue(String param, RecordFieldsConfig recordFields, String fieldName) {
        String fieldNames = recordFields.getFieldNames();
        if (fieldNames.contains(fieldName)) {
            return param;
        }
    ...
    public static Date getOptionalParamValue(Date param, RecordFieldsConfig recordFields, String fieldName) {
        String fieldNames = recordFields.getFieldNames();
        if (fieldNames.contains(fieldName)) {
            return param;
        }
    ...
    public static Integer getOptionalParamValue(Integer param, RecordFieldsConfig recordFields, String fieldName) {
        String fieldNames = recordFields.getFieldNames();
        if (fieldNames.contains(fieldName)) {
            return param;
        }
