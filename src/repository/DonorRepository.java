...
public class DonorRepository {
	...
	public List<Donor> find(String donorNumber, String firstName,
			String lastName) {
	...
	private List<Donor> filterByFirstName(List<Donor> donors,
		...
		List<Donor> filteredDonors = (List<Donor>) CollectionUtils.select(
				donors, new Predicate() {
	...
	public List<Donor> getAllDonors() {
		Query query = em.createQuery(
				"SELECT d FROM Donor d WHERE d.isDeleted = :isDeleted",
				Donor.class);
		query.setParameter("isDeleted", Boolean.FALSE);
