...
public class Request {
    ...
    public Request(String requestNumber, Date dateRequested, Date dateRequired, Long siteId, String productType, String abo, String rhd, Integer quantity, String comment, String status, Boolean deleted) {
