...
public class Donor implements ModificationTracker {
	...
	/**
	 * Donor Number column should be indexed. It has high selectivity. Search by
	 * donor number is very common usecase. VARCHAR(15) should be sufficient.
	 * Smaller index keys are better. In most cases, this field will be
	 * auto-generated.
	 */
	...
	/**
	 * Find donor by first few characters of first name can be made faster with
	 * this index.
	 */
	@Column(length = 20)
	...
	/**
	 * Find donor by first few characters of last name can be made faster with
	 * this index.
	 */
	@Length(max = 20)
	...
	/**
	 * Some people prefer to be called by a different name. If required this field
	 * can be used.
	 */
	@Length(max = 20)
	@Column(length = 20)
	...
	/**
	 * Just store the string for the gender. Low selectivity column. No need to
	 * index it.
	 */
	...
	/**
	 * If the blood center wishes to store a unique id for the donor. Can help in
	 * deduplication.
	 */
	@Column(length = 15)
	...
	/**
	 * If a donor has been deferred then we can disallow him to donate the next
	 * time.
	 */
	@NotAudited
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
